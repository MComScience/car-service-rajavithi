...
namespace metronic\menu\controllers;

use Yii;
use metronic\menu\models\Menu;
use metronic\menu\models\MenuSearch;
use metronic\menu\models\MenuCategorySearch;
        ...
        if($request->isAjax){
            ...
            foreach($rows as $i => $item){
                $items[] = [
                    ...
                    'parent' => ($item['parent_id'] != null && isset($array[$item['parent_id']])) ? $array[$item['parent_id']][0]['title'] : '',
                    'sort' => $item['sort'],
