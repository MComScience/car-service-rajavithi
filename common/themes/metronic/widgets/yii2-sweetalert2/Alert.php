...
namespace metronic\sweetalert2;

use Yii;
use yii\bootstrap\Widget;
use yii\helpers\Json;
use yii\helpers\ArrayHelper;
use metronic\sweetalert2\assets\SweetAlert2Asset;
use metronic\sweetalert2\assets\AnimateCssAsset;
use metronic\sweetalert2\assets\PolyfillAsset;
